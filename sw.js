const CACHE='bioolym7-v17-bio-world';
const CORE=[
  './', './index.html', './manifest.webmanifest', './icon-192.png', './icon-512.png',
  './mobile-wow.css', './bio-world.css', './config.js', './app-pro.js', './photo-fix.js', './teacher-plus.js', './bio-world.js',
...
function inject(html){
  const headAdds=['./mobile-wow.css','./bio-world.css'];
  ...
  ['./photo-fix.js','./teacher-plus.js','./bio-world.js'].forEach(s=>{ if(!html.includes(s)) html=html.replace('</body>',`<script src="${s}"></script></body>`); });
  return html;
}
