const CACHE='bioolym7-v11-elegant-wow';
const CORE=[
  './', './index.html', './manifest.webmanifest', './icon-192.png', './icon-512.png',
  './mobile-wow.css', './wow-theme.css', './super-wow.css', './bio-elegant-theme.css',
  './config.js', './app-pro.js', './photo-fix.js', './teacher-plus.js', './wow-design.js', './super-wow.js', './bio-elegant-design.js',
...
function inject(html){
  const headAdds=['./mobile-wow.css','./wow-theme.css','./super-wow.css','./bio-elegant-theme.css'];
  ...
  ['./photo-fix.js','./teacher-plus.js','./wow-design.js','./super-wow.js','./bio-elegant-design.js'].forEach(s=>{ if(!html.includes(s)) html=html.replace('</body>',`<script src="${s}"></script></body>`); });
  return html;
}
